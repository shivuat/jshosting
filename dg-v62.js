(async function() {
  ...
  function startRecording() {
    ...
    navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
      ...
      socket = new WebSocket('wss://api.deepgram.com/v1/listen?diarize=true&smart_format=true&redact=pii&model=nova-2', ['token', 'bf373551459bce132cef3b1b065859ed3e4bac8f']);
