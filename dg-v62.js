(async function() {
  ...
  // Create and style the transcript div (now content-editable)
  ...
  transcriptDiv.contentEditable = true;  // Make the transcript content-editable
  ...
  function startRecording() {
    ...
    navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
      ...
      socket = new WebSocket('wss://api.deepgram.com/v1/listen?diarize=true&smart_format=true&redact=pci&redact=pii&model=nova-2', ['token', 'bf373551459bce132cef3b1b065859ed3e4bac8f']);
